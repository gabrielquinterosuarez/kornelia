...
2. **Se publican las firmas de todas las tablas, se lean o no** (`kernel-core/src/protocol.rs:886#acpi_signatures`). Que exista en la máquina algo que este kernel todavía no sabe leer **es más útil que callarlo**: el agente ve la lista y decide.
