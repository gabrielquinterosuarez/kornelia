...
| **Dónde vive** | `kernel-core/src/protocol.rs:1539#exec needs mode: supervised or raw`, `kernel-x86_64/src/gdt.rs:166#gdt.0[3] = 0x00AF_FA00_0000_FFFF`, `kernel-aarch64/src/exec.rs:158#exec_supervised:` |
