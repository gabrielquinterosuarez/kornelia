...
| NVMe | **El kernel no tiene [[Driver|driver]]** (D4). El que hay está escrito con los once verbos, del lado del cliente: `scripts/client.py:1732#Le habla a un controlador NVMe`. Ver [[NVMe]]. |
