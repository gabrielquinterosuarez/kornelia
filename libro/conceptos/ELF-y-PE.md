...
| Reubicaciones | Nada. El kernel le pasa al código **su propia dirección** en el primer registro de argumento (`kernel-core/src/protocol.rs:1478#recibe en el primer registro de argumento su propia direccion`). |
