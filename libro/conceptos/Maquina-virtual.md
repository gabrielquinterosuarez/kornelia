...
| **Sobre el silicio** | `./scripts/client.py --kvm` — "que el codigo lo ejecute el silicio de verdad, no la emulacion" (`scripts/client.py:4837#que el codigo lo ejecute el silicio`) |
