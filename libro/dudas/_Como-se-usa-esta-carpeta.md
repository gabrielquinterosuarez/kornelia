...
1. Algo no cierra. Nota nueva desde [[Plantilla-duda]], nombre `YYYY-MM-DD-lo-que-no-cierra`.
2. Copiás el párrafo textual que no cerró. Esto importa: si después se reescribe, la cita es lo único que dice qué era lo confuso.
3. Lo discutimos.
4. Yo mejoro el capítulo o el concepto. **No contesto solo en el chat**: si la respuesta no queda en el libro, la duda vuelve en tres meses.
5. La duda pasa a `estado: cerrada` y apunta al párrafo nuevo.
